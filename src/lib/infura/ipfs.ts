...
const INFURA_IPFS_PROJECT_ID = '2SYLYjypaTwK9DJ4w7ELxAnmlWG' // process.env.INFURA_IPFS_PROJECT_ID
const INFURA_IPFS_API_SECRET = '810777249217d9a8de118c7a66883015' // process.env.INFURA_IPFS_API_SECRET
...
const origin =
  process.env.NODE_ENV === 'development' ? MAINNET_ORIGIN : MAINNET_ORIGIN
