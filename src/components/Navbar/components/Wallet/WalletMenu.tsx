...
export default function WalletMenu({ userAddress }: { userAddress: string }) {
  ...
  return (
    <DropdownMenu
      hideArrow
      heading={
        <div className="flex w-full cursor-pointer select-none items-center justify-center rounded-lg bg-orange-500/10 px-4 py-2.5">
          <EthereumAddress
            address={userAddress}
            tooltipDisabled
            linkDisabled
            className="select-none text-sm font-medium text-orange-500"
          />
        </div>
      }
