...
import { useEthSignLaunchProjectWithNftsTx } from 'hooks/JB721Delegate/transactor/useEthSignLaunchProjectWithNftsTx'
...
export const useDeployNftProject = () => {
  const launchProjectWithNftsTx = useEthSignLaunchProjectWithNftsTx()
  const {
    projectMetadata,
    nftRewards,
    payoutGroupedSplits,
