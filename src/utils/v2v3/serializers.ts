...
export const serializeV2V3FundingCycleMetadata = (
  ...
  const baseSerializedMetadata = {
    ...
    tokenUnlockingSchedules: JSON.stringify(
  ...
  return {
    ...
    tokenUnlockingSchedules:
      v3FundingCycleMetadata.tokenUnlockingSchedules?.toString() ?? '[]',
...
export const deserializeV2V3FundingCycleMetadata = (
  ...
  const baseMetadata: BaseV2V3FundingCycleMetadata = {
    ...
    tokenUnlockingSchedules:
      serializedFundingCycleMetadata.tokenUnlockingSchedules,
    tokenName: serializedFundingCycleMetadata.tokenName,
    tokenSymbol: serializedFundingCycleMetadata.tokenSymbol,
  }
...
export const deserializeV2V3FundingCycleData = (
  ...
  tokenUnlockingSchedules: JSON.parse(
    serializedFundingCycleData.tokenUnlockingSchedules,
  ),
})
